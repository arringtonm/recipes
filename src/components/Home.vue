...
export default {
  ...
  methods: {
    ...
    goHome: function() {
      const recipeName = this.activeRecipe.name
        .replace(/\s+/g, "-")
        .toLowerCase();
      history.pushState(null, recipeName, "/");
  ...
  data: function() {
    return {
      ...
      //     name: "Oyster Po Boys",
      //     id: 40,
      //     keywords: ["Cajun", "Spicey", "New Orleans", "Southern", "Oyster"],
      //     description:
      ...
      //       "4 large eggs",
      //       "24 freshly shucked oysters, liquid reserved and shells discarded",
      //       "2 quarts (1900ml) vegetable oil, for frying",
      //       "Kosher salt",
      //       "4 (10-inch) French or sub-style rolls, lightly toasted",
      ...
      //   },
      //   {
      //     _id: "5c87f66d307bb300000263f5",
      //     name: "Easy Pressure Cooker Pork Chile Verde",
      //     keywords: ["Pressure Cooker", "Pork", "Healthy", "Quick", "Mexican"],
      //     id: 1,
      //     description:
      ...
      //   },
      //   {
      //     _id: "5c894c21307bb30000028e17",
      //     name: "Toro Bravo's Radicchio Salad",
      //     keywords: ["Salad", "John Gorham", "Toro Bravo", "Radicchio"],
      //     id: 2340,
      //     description:
      ...
      //       "1 tablespoon honey",
      //       "3/4 cup olive oil",
      //       "1 1/2 cups Machego, finely grated and divided",
      ...
      //     image: "img/tororiddichio.jpg"
      //   },
      //   {
      //     _id: "5c87f66e307bb300000263f6",
      //     name:
      ...
      //   },
      //   {
      //     _id: "5c897d6a307bb30000029112",
      //     name: "Ultra-Smashed Cheeseburgers",
      //     keywords: ["Serious Eats", "Cheeseburger", "BBQ", "Grill"],
      //     id: 53450,
      //     description:
      ...
      //     cookTime: "5 minutes",
      //     totalTime: "5 minutes",
      //     recipeYield: "Makes one burger"
      //   },
      //   {
      //     _id: "5c899d0f307bb30000029290",
      //     name: "The Best Slow-Cooked Bolognese Sauce",
      //     keywords: ["Italian", "Hearty", "Pasta"],
      //     id: 42340,
      //     description:
      ...
      //     image: "img/bolognese.jpg",
      //     favorite: false,
      //     ingredients: [
      //       "1 quart (1L) homemade or store-bought low-sodium chicken stock",
      //       "1 to 1 1/2 ounces powdered gelatin (4 to 6 packets; 30 to 45g), such as Knox",
      ...
      //     ],
      //     cookTime: "60 minutes",
      //     totalTime: "4 to 5 hours",
      //     recipeYield: "8-10 servings"
      //   },
      //   {
      //     _id: "5c89d025307bb30000029715",
      //     name: "Jalapeño Cheddar Cornbread",
      //     keywords: ["Sides", "Mexican", "Bread", "Spicey"],
      //     id: 6350,
      //     description:
      //       "Cornbread with a kick of heat! This easy to make cornbread is more interesting than your typical sweet and often dry cornbread. The cheesy, salty and spicy twist on your typical cornbread is dense, moist and ridiculously addicting. ",
      //     image: "img/cornbread.jpg",
      //     favorite: false,
      //     ingredients: [
      ...
      //     recipeYield: "12 large pieces"
      //   },
      //   {
      //     _id: "5c89d0f4307bb30000029727",
      //     name: "Sous Vide Carrots",
      //     keywords: ["Sous Vide", "Vegetables", "Carrots", "Healthy"],
      //     id: 6450,
      //     description:
      //       "This basic technique retains the natural sweetness, bright color, and firm bite that are often lost when cooking carrots in traditional ways.",
      //     image: "img/sousvidecarrots.jpg",
      //     favorite: false,
      //     ingredients: [
      //       "500 g Carrots",
      ...
      //     ],
      //     instructions: [
      //       "Fill heat proof container with water",
      //       "Heat water to 194 degrees Fahrenheit",
      //       "Peel carrots and put into plastic bag",
      //       "Put a little oil or butter in the plastic bag to keep the carrots from sticking to one another",
      //       "Cook Sous Vide at 194 degrees Fahrenheit for about 15 to 25 minutes",
      //       "Slice and season the carrots",
      //       "Serve"
      //     ],
      ...
      //   },
      //   {
      //     _id: "5c89d27c307bb3000002973d",
      //     name: "Molten Chocolate Cakes with Raspberries and Cream",
      //     keywords: ["Dessert", "Chocolate", "Date night", "Cake"],
      //     id: 7650,
      //     description:
      //       "The magic of chocolate-oozing molten cakes will never not be impressive, romantic or special. Impress your date. Impress your guests. Impress yourself with how easy it is to make a spectacular desert in less than 30 minutes. ",
      //     image: "img/moltencake.jpg",
      //     favorite: false,
      //     ingredients: [
      //       "1 1/2 teaspoons unsalted butter, plus 1/4 pound (1 stick)",
      //       "4 teaspoons flour, plus 2 tablespoons",
      ...
      //   },
      //   {
      //     _id: "5c89d462307bb30000029755",
      //     name: "Mini Animal Crackers",
      //     keywords: ["Dessert", "Cookie"],
      //     id: 48304,
      //     description:
      //       "Adorable and beloved animal crackers without any nasty preservatives. This basic sugar cookie recipe is simple and straightforward and will take you back to childhood. ",
      //     image: "img/animalcrackers.jpg",
      //     favorite: false,
      //     ingredients: [
      ...
      //       "Decorate with traditional royal icing and sprinkles"
      //     ],
      //     cookTime: "2 hours, 15 minutes",
      //     totalTime: "4 hours, 30 minutes",
      //     recipeYield: "85 mini cookies"
      //   },
      //   {
      //     _id: "5c89dd10307bb300000297da",
      //     name: "Wifey's Salad Rolls",
      //     keywords: ["Healthy", "Vietnamese", "Appetizer"],
      //     id: 94533,
      //     description:
      //       "Don't pay $7 for someone else to roll your Vietnamese cravings. Empower yourself to make your own satisfying crunchy, refreshing and healthy salad rolls. You've got this.",
      //     image: "img/saladrolls.jpg",
      //     favorite: false,
      //     ingredients: [
      ...
      //       "1/3 cup of mint",
      //       "12 pieces of cooked shrimp",
      //       "Four rice paper wraps"
      //     ],
      //     instructions: [
      //       "Wash and thoroughly dry all of your veggies",
      //       "Pluck the mint and basil leaves from their stems and put each in separate prep bowls",
      //       "Cut lettuce into three separate pieces with the spine in the middle",
      //       "Remove the tail from cooked shrimp",
      //       "Bring water to steaming temperature but not boiling",
      //       'Pour hot water into heat proof bowl with a 10" diameter',
      //       "Arrange the prepared vegetables and shrimp on a cutting board in the following order: lettuce, basil, bean sprouts, mint, shrimp",
      //       "Soften wraps in hot water",
      //       "Gently stretch softened wrap onto a cutting board",
      //       "For each wrap ayer 1 slice of lettuce, 3 leaves of basil, quarter cup of bean sprouts and three mint leaves onto bottom third of the wrap",
      //       "Roll the wrap but leave last third unclosed",
      //       "Place three shrimp in a vertical line on the remaining unfolded wrap",
      //       "Fold final portion of the wrap and tuck in the sides like a burrito",
      ...
      //   },
      //   {
      //     _id: "5c89f285307bb30000029930",
      //     name: "Easy Oven-Cooked Pulled Pork",
      //     keywords: ["Meat", "Pork", "Dinner", "Slow Cook"],
      //     id: 7650,
      //     description:
      //       "This recipe produces pulled pork that shreds into large, tender chunks that are moist but not wet, with a flavor that balances sweet molasses, bright vinegar, heat, and just a hint of smoke. Oh, and it's darn easy, to boot.",
      ...
      //   },
      //   {
      //     _id: "5c89f4fe307bb30000029954",
      //     name: "Roasted Kohlrabi and Butternut Squash",
      //     keywords: [
      //       "Sides",
      //       "Vegetables",
      //       "Healthy",
      ...
      //     id: 98730,
      //     description:
      //       "Its earthy, sweet flavors to its velvety, crisp texture make this easy roasting dish a success on those dark winter days when you want color and delicious foods. ",
      //     image: "img/roastedsquash.jpg",
      //     favorite: false,
      //     ingredients: [
